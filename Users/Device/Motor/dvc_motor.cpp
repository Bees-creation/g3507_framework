...
void Class_Brush_Motor::Init(TIMER_INST *TIMx, TIMER_CHANNEL __Channel, const Enum_Motor_Control_Method &__Control_Method, const Enum_Motor_Control_Algorithm &__Control_Algorithm) {
    TIM = TIMx;
    Channel = __Channel;
...
void Class_Brush_Motor::TIM_Calculate_PeriodElapsedCallback() {
...
void Class_Brush_Motor_Drv8701e::Init(TIMER_INST *TIMx, TIMER_CHANNEL __Channel, const Enum_Motor_Control_Method &__Control_Method, const Enum_Motor_Control_Algorithm &__Control_Algorithm, GPIO_PORT *__Direction_Port, GPIO_PIN __Direction_Pin, GPIO_PORT *__Enable_Port, GPIO_PIN __Enable_Pin) {
    Class_Brush_Motor::Init(TIMx, __Channel, __Control_Method, __Control_Algorithm);

    Direction_Port = __Direction_Port;
    Direction_Pin = __Direction_Pin;
    Enable_Port = __Enable_Port;
    Enable_Pin = __Enable_Pin;
