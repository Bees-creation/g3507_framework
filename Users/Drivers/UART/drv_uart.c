...
void UART_DMA_Init(
    ...
    if (UARTx == UART0) {
        ...
        UART0_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART0_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
#if defined UART1_BASE
    if (UARTx == UART1) {
        ...
        UART1_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART1_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
#if defined UART2_BASE
    if (UARTx == UART2) {
        ...
        UART2_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART2_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
#if defined UART3_BASE
    if (UARTx == UART3) {
        ...
        UART3_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART3_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
#if defined UART4_BASE
    if (UARTx == UART4) {
        ...
        UART4_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART4_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
#if defined UART5_BASE
    if (UARTx == UART5) {
        ...
        UART5_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART5_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
#if defined UART6_BASE
    if (UARTx == UART6) {
        ...
        UART6_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART6_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
#if defined UART7_BASE
    if (UARTx == UART7) {
        ...
        UART7_Manage_Object.DMA_Tx_Manage_Object = DMA_Init(DMAx, DMA_Rx_CH_CHAN_ID, (uint32_t)&UARTx->RXDATA, (uint32_t)&UART7_Manage_Object.Rx_Buffer, UART_BUFFER_SIZE);
    }
#endif
}
...
#if defined UART0_BASE
        if (UARTx == UART0) {
            return DMA_Receive_Data(UART0_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
#if defined UART1_BASE
        if (UARTx == UART1) {
            return DMA_Receive_Data(UART1_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
#if defined UART2_BASE
        if (UARTx == UART2) {
            return DMA_Receive_Data(UART2_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
#if defined UART3_BASE
        if (UARTx == UART3) {
            return DMA_Receive_Data(UART3_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
#if defined UART4_BASE
        if (UARTx == UART4) {
            return DMA_Receive_Data(UART4_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
#if defined UART5_BASE
        if (UARTx == UART5) {
            return DMA_Receive_Data(UART5_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
#if defined UART6_BASE
        if (UARTx == UART6) {
            return DMA_Receive_Data(UART6_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
#if defined UART7_BASE
        if (UARTx == UART7) {
            return DMA_Receive_Data(UART7_Manage_Object.DMA_Tx_Manage_Object, pData, Size);
        }
#endif
    }
    else {
